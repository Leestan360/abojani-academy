  ...
  return (
    <div className="w-full py-8 pl-8 pr-32">
      ...
      <div className="community-topics-div">
        <div style={{ width: "33%" }}>
          <h3 className="text-[#575757] text-xl font-medium mb-4">
            Trending News
          </h3>
          <div className="" style={{}}>
            {news.map((items) => (
              <div
                className="flex border mb-4 p-4 rounded-md fetched-div"
                key={items.id}
              >
                <div style={{ width: "75%" }}>
                ...
                <div style={{ width: "25%" }}>
                  <img
                    className="rounded-md float-right news-image"
                    src={items.image}
                    alt=""
                  />
                </div>
        ...
        <div style={{ width: "64%" }}>
          ...
          <div className="py-4 px-8 bg-[#fff] mb-8 rounded-md stock-recommendations">
            <div className="flex justify-between items-center mb-4">
              <img
                src="https://elvis-munene.github.io/Abojani-Academy-web-app/assets/images/Ellipse%20(1).png"
                alt=""
              />
              <div className="w-5/6">
                <h2 className="text-2xl font-medium">Cannabis Stocks</h2>
                <p>
                  <span className="text-base font-bold text-[#40b551]">
                    +2.90%
                  </span>{" "}
                  <span className="ml-8 font-bold">21 Symbols</span>
                </p>
              </div>
              <div>
            ...
            <p>
              The JSE has announced the deployment of an online trading
              analytics platform for listed firms and exchange traded
              funds(ETFs). This software has been provided
            </p>
          </div>
