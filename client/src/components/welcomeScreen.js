        ...
        <div className="h-full w-full flex welcome-screen-div-one">
          <div className="w-2/4 ">
            ...
            <div className="border border-black max-w-lg p-8 bg-white grid w-3/5 m-40 rounded-xl" >
              ...
              <p className="text-base text-black pb-5 leading-6 ">
                We shorten the time between learning and investing and saving by connecting our clients
              </p>
              <button className="bg-amber-600 py-2 px-2 text-2xl rounded cursor-pointer shadow-slate-400 border-none m-7 ">Log in</button> 
              <button className="bg-white py-1 px-2 text-2xl rounded cursor-pointer text-amber-600 shadow-slate-400 border border-solid border-amber-600 m-0">Create Account</button>
            </div>
          </div>
        </div>
      </div>
