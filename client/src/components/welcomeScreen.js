      ...
      <div className="h-full w-full flex welcome-screen-div-one">
        ...
        <div className="bg-green-500 text-white w-2/4 h-screen  grid-rows-1 grid-cols-1 grid ">
          <div className="border border-black max-w-lg p-8 bg-white grid w-3/5 m-40 rounded-xl">
            ...
            <NavLink to="/login">
              <button className="bg-amber-600 py-3 px-9 text-2xl rounded cursor-pointer shadow-slate-400 border-none m-2 ">
                Log in
              </button>{" "}
            </NavLink>
            <NavLink to="/signup">
              <button className="bg-white py-1 px-2 text-2xl rounded cursor-pointer text-amber-600 shadow-slate-400 border border-solid border-amber-600 m-0">
                Create Account
              </button>
            </NavLink>
          </div>
